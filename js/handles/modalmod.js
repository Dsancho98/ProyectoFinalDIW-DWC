...
templates['modalmod'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div>\r\n	<input id=\"idoculta\" type=\"text\" maxlength=\"50\" class=\"form-control\" value='"
    ...
    + "'>\r\n</div>\r\n<div>	\r\n	<input type=\"radio\" id='radiomod1' name=\"alternativas\" value=\"M\" "
    ...
    + "> \r\n	<label for='radiomod1'><b>Masculino</b></label>\r\n	\r\n	<input type=\"radio\" id='radiomod2' name=\"alternativas\" value=\"F\" "
    ...
    + "' hidden>\r\n</div>\r\n<div>\r\n	<button type='button' class='btn waves-effect waves-light' id=\"okmodifyuser\" value=\"submit\">Modificar</button>\r\n	<input type=\"reset\" class='btn waves-effect waves-light' id='canceluser' value='Cancelar'>\r\n</div>\r\n";
},"useData":true});
})();